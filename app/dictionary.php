...
function getDicByType($type){
	$select_datas = select_datas();
	$datas = $select_datas[$type];
	return $datas;
}
 ...
 *用于多选框，
 *@param $type
 *@param $codes 编号列表，例如 “1，2，3，4”
 *@param $plfs 排列方式： 1、横排；2、竖排
 */
function getDicNames($type,$codes,$plfs){
	if(empty($code)){
		return '';
	}
	$name = '';
